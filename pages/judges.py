...
with col_how:
    ...
    st.caption(
        ...
        "**Per-issue grading** — For every issue in the answer key, the judge "
        "checks four things:\n\n"
        "| | |\n|---|---|\n"
        "| **Identified** | Did the response spot this issue? |\n"
        "| **Characterized** | Did it describe the issue accurately? |\n"
        "| **Severity** | Did it flag the right level of risk? |\n"
        "| **Actionable** | Did it suggest a concrete fix? |\n\n"
        "**Overall quality** — The judge also rates the response as a whole on "
        "completeness, precision, professional quality, and whether it got the "
        "overall risk classification right.\n\n"
        "These scores are combined into a single **composite score** so you can "
